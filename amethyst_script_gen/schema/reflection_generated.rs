...
impl<'a> EnumVal<'a> {
  ...
  #[inline]
  pub fn documentation(&self) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<&'a str>>> {
...
impl<'a> Enum<'a> {
  ...
  #[inline]
  pub fn values(&self) -> flatbuffers::Vector<flatbuffers::ForwardsUOffset<EnumVal<'a>>> {
  ...
  #[inline]
  pub fn attributes(&self) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<KeyValue<'a>>>> {
...
impl<'a> Object<'a> {
  ...
  #[inline]
  pub fn fields(&self) -> flatbuffers::Vector<flatbuffers::ForwardsUOffset<Field<'a>>> {
...
impl<'a> Service<'a> {
  ...
  #[inline]
  pub fn calls(&self) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<RPCCall<'a>>>> {
...
impl<'a> Schema<'a> {
  ...
  #[inline]
  pub fn objects(&self) -> flatbuffers::Vector<flatbuffers::ForwardsUOffset<Object<'a>>> {
  ...
  #[inline]
  pub fn enums(&self) -> flatbuffers::Vector<flatbuffers::ForwardsUOffset<Enum<'a>>> {
  ...
  #[inline]
  pub fn services(&self) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Service<'a>>>> {
