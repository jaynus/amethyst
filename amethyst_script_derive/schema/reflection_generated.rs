...
pub enum ForeignFunctionOffset {}
#[derive(Copy, Clone, Debug, PartialEq)]
...
impl<'a> flatbuffers::Follow<'a> for ForeignFunction<'a> {
    type Inner = ForeignFunction<'a>;
    #[inline]
    fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
            _tab: flatbuffers::Table { buf: buf, loc: loc },
...
impl<'a> ForeignFunction<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args ForeignFunctionArgs<'args>) -> flatbuffers::WIPOffset<ForeignFunction<'bldr>> {
      let mut builder = ForeignFunctionBuilder::new(_fbb);
      if let Some(x) = args.documentation { builder.add_documentation(x); }
      if let Some(x) = args.attributes { builder.add_attributes(x); }
    ...
    pub const VT_RETVAL: flatbuffers::VOffsetT = 8;
    pub const VT_ATTRIBUTES: flatbuffers::VOffsetT = 10;
    pub const VT_DOCUMENTATION: flatbuffers::VOffsetT = 12;

  #[inline]
  pub fn name(&self) -> &'a str {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ForeignFunction::VT_NAME, None).unwrap()
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &ForeignFunction) ->  bool {
    self.name() < o.name()
  }
  ...
  #[inline]
  pub fn arguments(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Object<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Object<'a>>>>>(ForeignFunction::VT_ARGUMENTS, None)
  }
  #[inline]
  pub fn retval(&self) -> Option<Object<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Object<'a>>>(ForeignFunction::VT_RETVAL, None)
  }
  #[inline]
  pub fn attributes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KeyValue<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<KeyValue<'a>>>>>(ForeignFunction::VT_ATTRIBUTES, None)
  }
  #[inline]
  pub fn documentation(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<&'a str>>>>(ForeignFunction::VT_DOCUMENTATION, None)
  }
}

pub struct ForeignFunctionArgs<'a> {
    pub name: Option<flatbuffers::WIPOffset<&'a  str>>,
    pub arguments: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a , flatbuffers::ForwardsUOffset<Object<'a >>>>>,
    pub retval: Option<flatbuffers::WIPOffset<Object<'a >>>,
    pub attributes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a , flatbuffers::ForwardsUOffset<KeyValue<'a >>>>>,
    pub documentation: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a , flatbuffers::ForwardsUOffset<&'a  str>>>>,
}
impl<'a> Default for ForeignFunctionArgs<'a> {
    #[inline]
    fn default() -> Self {
        ForeignFunctionArgs {
            name: None, // required field
...
pub struct ForeignFunctionBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> ForeignFunctionBuilder<'a, 'b> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ForeignFunction::VT_NAME, name);
  }
  #[inline]
  pub fn add_arguments(&mut self, arguments: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Object<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ForeignFunction::VT_ARGUMENTS, arguments);
  }
  #[inline]
  pub fn add_retval(&mut self, retval: flatbuffers::WIPOffset<Object<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Object>>(ForeignFunction::VT_RETVAL, retval);
  }
  #[inline]
  pub fn add_attributes(&mut self, attributes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<KeyValue<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ForeignFunction::VT_ATTRIBUTES, attributes);
  }
  #[inline]
  pub fn add_documentation(&mut self, documentation: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ForeignFunction::VT_DOCUMENTATION, documentation);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ForeignFunctionBuilder<'a, 'b> {
    let start = _fbb.start_table();
    ForeignFunctionBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<ForeignFunction<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, ForeignFunction::VT_NAME,"name");
    flatbuffers::WIPOffset::new(o.value())
  }
}
